...
<body class="bg-gray-100 flex flex-col items-center justify-center min-h-screen">
    ...
    <form action="audio-upload.php" method="POST" enctype="multipart/form-data" class="bg-white shadow-lg rounded-lg p-8 max-w-lg w-full">
        <h2 class="text-center text-lg font-semibold mb-6">Audio File Upload</h2>
        <div class="bg-gray-800 rounded-lg p-10 text-center text-white">
            <label for="audio-upload" class="block mb-2">UPLOAD AN AUDIO FILE</label>
            <input type="file" id="audio-upload" name="audio_file" accept="audio/*" class="block w-full text-sm text-slate-500
